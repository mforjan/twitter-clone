...
var _InputBox = __webpack_require__(42);

var _InputBox2 = _interopRequireDefault(_InputBox);

var _TweetContainer = __webpack_require__(71);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_TweetContainer2.default, null)
        )
      );
    }
  }]);
...
var InputBox = function (_React$Component) {
  ...
  _createClass(InputBox, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'form',
        { className: 'box col', onSubmit: this.handleSubmit },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addTweetClick: function addTweetClick(username, handle, message, date) {
      return dispatch((0, _actions.addTweet)(username, handle, message, date));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(InputBox);
...
function addTweet(username, handle, message, date) {
  return {
    type: 'ADD_TWEET',
    username: username,
    handle: handle,
...
var _Tweet = __webpack_require__(72);
...
var TweetContainer = function (_React$Component) {
  _inherits(TweetContainer, _React$Component);

  function TweetContainer(props) {
    _classCallCheck(this, TweetContainer);

    var _this = _possibleConstructorReturn(this, (TweetContainer.__proto__ || Object.getPrototypeOf(TweetContainer)).call(this, props));
  ...
  _createClass(TweetContainer, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'container' },
        this.props.state.map(function (tweet) {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(TweetContainer);
